...
/*
 * Adaptirano iz react-bits SimpleGraph: bez "use client", cn iz ../lib/cn, a
 * TrendingUp/TrendingDown su inline SVG (bez lucide-react zavisnosti). Tooltip
 * na tackama sa `label` pokazuje sam label (npr. godinu), a ne sirov broj.
 */
...
const SimpleGraph = ({
  ...
  }, [data, curved, calculatePercentageDifference]);
