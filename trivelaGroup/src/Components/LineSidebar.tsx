      ...
      >
        {items.map((label, index) => (
          <li
            ...
            className={`relative cursor-pointer hover:[--effect:1] aria-[current=true]:[--effect:1] before:absolute before:-inset-x-12 before:-inset-y-[6px] before:content-[''] ${tickClass}`}
          >
            {showMarker && (
              <span
                aria-hidden="true"
